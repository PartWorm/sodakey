...
import com.partworm.sodakey.hangulutil.HangulUtil
import java.util.*

class HangulIme : Ime {

  private var onComposingStringChangeListener = noOp
  private var onCompositionCompleteListener = noOp
  ...
  fun setOnComposingStringChangeListener(listener: (String) -> Unit) {
    onComposingStringChangeListener = listener
  }

  fun setOnCompositionCompleteListener(listener: (String) -> Unit) {
    onCompositionCompleteListener = listener
  }
